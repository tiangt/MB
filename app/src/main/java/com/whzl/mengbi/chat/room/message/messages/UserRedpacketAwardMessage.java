 ...
 * @date 2019-09-18
 */
public class UserRedpacketAwardMessage implements FillHolderMessage {
    private final Context context;
    private final UserRedpacketAwardJson json;

    public UserRedpacketAwardMessage(Context context, UserRedpacketAwardJson userRedpacketAwardJson) {
