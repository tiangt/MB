...
public class UserRedpacketBroadMessage implements FillHolderMessage {
    ...
    public void fillHolder(RecyclerView.ViewHolder holder) {
        ...
        mholder.textView.setOnClickListener(v -> {
            if (((LiveDisplayActivity) context).hideChatDialog()) {
                return;
            }
            ((LiveDisplayActivity) context).showJumpLiveHouseDialog(json.context.uGameRedpacketDto.programId, json.context.anchorInfo.nickname);
        });
    }
