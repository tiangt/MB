...
public class RoundBackgroundColorSpan extends ReplacementSpan {
    ...
    public void draw(@NonNull Canvas canvas,
        ...
        RectF rectF = new RectF(x + 2.5f, y + 2.5f + paint.ascent(), x + liangSize, y + paint.descent());
...
//        paint.setShader(null);
        ...
        paint.setStrokeWidth(UIUtil.dip2px(context, 1));
        paint.setAntiAlias(true);
        RectF rectF2 = new RectF(x + liangSize - 6, y + 2.5f + paint.ascent(), x + mSize + 5, y + paint.descent());
        //设置文字背景矩形，x为span其实左上角相对整个TextView的x值，y为span左上角相对整个View的y值。
        // paint.ascent()获得文字上边缘，paint.descent()获得文字下边缘
        //x+2.5f解决线条粗细不一致问题
