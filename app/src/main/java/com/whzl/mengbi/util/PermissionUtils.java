...
public class PermissionUtils {
     ...
     *
     * @param activity
     * @param requestCode，例如，如果您需要请求CAMERA权限，参数是PermissionUtils.CODE_CAMERA
     */
...
//        }
    ...
    /**
     * @param activity
     * @param requestCode  需要与requestPermission一致
     * @param permissions
     * @param grantResults
     */
    ...
    /**
     * @param activity
     * @param isShouldRationale true: 返回未授予且shouldShowRequestPermissionRationale权限，false：返回未授予且！shouldShowRequestPermissionRationale
     * @return
     */
