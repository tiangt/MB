...
public class WeekStarView extends AppCompatTextView {
    public final static String TAG = WeekStarView.class.getSimpleName();
    ...
    public WeekStarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeekStarView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context = context;
        viewWidth = UIUtil.getScreenWidthPixels(getContext()) - UIUtil.dip2px(getContext(), 28);
    }
