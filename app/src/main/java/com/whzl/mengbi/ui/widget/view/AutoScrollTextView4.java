 ...
 * @date 2018/8/2
 */
public class AutoScrollTextView4 extends AppCompatTextView {
    public final static String TAG = AutoScrollTextView4.class.getSimpleName();
    ...
    public AutoScrollTextView4(Context context) {
        this(context, null);
    }

    public AutoScrollTextView4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoScrollTextView4(Context context, AttributeSet attrs, int defStyle) {
