...
/**
* Description: Generic 的最小高度为系统 ActionBar 的高度
* 1. 可以直接在Xml文件中直接使用
* 2. 可以使用Builder动态的植入
*/
public class GenericToolbar extends Toolbar {
    ...
    private void init() {
        ...
        mCenterItemContainer.setPadding((int) dp2px(5), (int) dp2px(1),
                (int) dp2px(5), (int) dp2px(5));
    ...
    public static class Builder {
        ...
        public Builder setBackgroundDrawable(@DrawableRes int drawableRes) {
            mToolbar.setBackground(ContextCompat.getDrawable(mContext, drawableRes));
            return this;
        }
